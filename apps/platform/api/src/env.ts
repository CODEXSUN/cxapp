...
const envSchema = z.object({
  ...
  AUTH_MODE: z.enum(["cookie", "jwt", "hybrid"]).default("hybrid"),
  AUTH_SESSION_RENEWAL_HOURS: z.coerce.number().int().positive().default(24),
  AUTH_SESSION_TTL_HOURS: z.coerce.number().int().positive().max(720).default(168),
  ...
  CODEXSUN_QUEUE_BACKEND: z.enum(["memory", "database", "bullmq-redis"]).default("database"),
