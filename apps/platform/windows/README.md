...
Version `1.0.58` is the first private Windows enrollment release. Do not describe it as an offline
billing release. The local runtime and module sync gates remain open.
