...
import type { UnitsRecord } from "./units.types";
...
export function UnitsList({
  ...
  loading: boolean;
  onEdit: (record: UnitsRecord) => void;
  onForceDelete: (record: UnitsRecord) => void;
  onRestore: (record: UnitsRecord) => void;
  onSuspend: (record: UnitsRecord) => void;
  records: UnitsRecord[];
}) {
  const columns: ColumnDef<UnitsRecord>[] = [
    {
