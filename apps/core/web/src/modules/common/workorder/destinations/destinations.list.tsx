...
import type { DestinationsRecord } from "./destinations.types";
...
export function DestinationsList({
  ...
  loading: boolean;
  onEdit: (record: DestinationsRecord) => void;
  onForceDelete: (record: DestinationsRecord) => void;
  onRestore: (record: DestinationsRecord) => void;
  onSuspend: (record: DestinationsRecord) => void;
  records: DestinationsRecord[];
}) {
  const columns: ColumnDef<DestinationsRecord>[] = [
    {
