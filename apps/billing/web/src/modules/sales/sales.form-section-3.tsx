...
import { Field } from "./sales.form-section-4";
import {
  RoundOffRow,
  TotalRow,
  computeSaleLine,
...
export function SaleItemsSection({
  ...
  const grandTotal = totals.amount + saleDecimalValue(roundOff);
                  ...
                  <WorkspaceLookup
                    ...
                    onValueChange={(value, option) =>
                      onDraftChange({
                        ...
                        colourId: numericId((option as SaleLookupOption | undefined)?.record?.id)
                      })
                    }
                  ...
                  <WorkspaceLookup
                    ...
                    onValueChange={(value, option) =>
                      onDraftChange({
                        ...
                        sizeId: numericId((option as SaleLookupOption | undefined)?.record?.id)
                      })
                    }
                ...
                return (
                  ...
                  >
                    ...
                    <td className="border-r border-border/70 px-3 py-2 text-right">
                      {formatMoney(saleDecimalValue(item.rate))}
                    </td>
