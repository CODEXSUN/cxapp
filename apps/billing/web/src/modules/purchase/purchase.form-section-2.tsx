...
export function purchaseLocationOption(record: PurchaseLocationRecord): PurchaseLookupOption {
...
export function purchaseContactOption(record: PurchaseLookupRecord): PurchaseLookupOption {
...
export function purchasePersistedOption(record: PurchaseLookupRecord): PurchaseLookupOption {
  const label = record.name || record.code || record.id;
  return { label, record, value: String(record.id) };
}

export function PurchaseWorkOrderQuickForm({
  initialValue,
  loading,
  onCancel,
  onSave,
...
export function masterPayload(kind: "products" | "workOrders", payload: PurchaseMasterSavePayload) {
...
export function purchaseProductOption(record: PurchaseLookupRecord): PurchaseLookupOption {
  const label = record.name || record.code || record.id;
  return {
...
export function purchaseWorkOrderOption(record: PurchaseLookupRecord): PurchaseLookupOption {
...
export function purchaseCommonOption(record: PurchaseLookupRecord): PurchaseLookupOption {
  const label = record.name || record.code || record.id;
