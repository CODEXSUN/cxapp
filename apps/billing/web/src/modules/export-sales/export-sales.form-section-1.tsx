...
import {
  exportSaleLocationOption,
  exportSalePersistedOption,
  locationPatch,
  locationPayload
...
export function ExportSaleContactQuickForm({
  initialValue,
  loading,
  onCancel,
  onSave,
  ...
  const contactTypesQuery = useQuery({
    queryFn: listExportSaleContactTypes,
    queryKey: ["billing", "exportSale", "lookups", "contact-types"]
  });
          ...
          <label className="grid gap-2">
            ...
            <WorkspaceLookup
              ...
              onCreate={async (name) => {
                ...
                return exportSalePersistedOption(created);
              }}
