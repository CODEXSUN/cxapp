...
export async function migrateSalesModule<Database>(database: Kysely<Database>) {
  ...
  await sql
    ...
    CREATE TABLE IF NOT EXISTS billing_sales (
      ...
      CONSTRAINT billing_sales_company_fk FOREIGN KEY (company_id) REFERENCES core_companies (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_financial_year_fk FOREIGN KEY (financial_year_id) REFERENCES core_financial_years (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_customer_fk FOREIGN KEY (customer_id) REFERENCES core_contacts (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_billing_address_fk FOREIGN KEY (billing_address_id) REFERENCES core_contacts_addresses (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_shipping_address_fk FOREIGN KEY (shipping_address_id) REFERENCES core_contacts_addresses (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_work_order_fk FOREIGN KEY (work_order_id) REFERENCES core_work_orders (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_ledger_fk FOREIGN KEY (ledger_id) REFERENCES core_ledgers (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_currency_fk FOREIGN KEY (currency_id) REFERENCES core_currencies (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_created_by_fk FOREIGN KEY (created_by) REFERENCES app_users (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_updated_by_fk FOREIGN KEY (updated_by) REFERENCES app_users (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_confirmed_by_fk FOREIGN KEY (confirmed_by) REFERENCES app_users (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_cancelled_by_fk FOREIGN KEY (cancelled_by) REFERENCES app_users (id) ON DELETE RESTRICT
  ...
  await sql
    ...
    created_by VARCHAR(191) NOT NULL DEFAULT 'system:migration',
      ...
      CONSTRAINT billing_sales_items_sales_fk FOREIGN KEY (sales_id) REFERENCES billing_sales (id) ON DELETE CASCADE,
      CONSTRAINT billing_sales_items_product_fk FOREIGN KEY (product_id) REFERENCES core_products (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_items_hsn_fk FOREIGN KEY (hsn_code_id) REFERENCES core_hsn_codes (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_items_colour_fk FOREIGN KEY (colour_id) REFERENCES core_colours (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_items_size_fk FOREIGN KEY (size_id) REFERENCES core_sizes (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_items_unit_fk FOREIGN KEY (unit_id) REFERENCES core_units (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_items_tax_fk FOREIGN KEY (tax_id) REFERENCES core_taxes (id) ON DELETE RESTRICT
    ) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
  `
    )
    .execute(database);
  ...
  await sql
    ...
    created_by VARCHAR(191) NOT NULL DEFAULT 'system:migration',
      ...
      CONSTRAINT billing_sales_eway_sale_fk FOREIGN KEY (sales_id) REFERENCES billing_sales (id) ON DELETE CASCADE,
      CONSTRAINT billing_sales_eway_transport_fk FOREIGN KEY (transport_id) REFERENCES core_transports (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_eway_generated_by_fk FOREIGN KEY (generated_by) REFERENCES app_users (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_eway_cancelled_by_fk FOREIGN KEY (cancelled_by) REFERENCES app_users (id) ON DELETE RESTRICT
    ) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
  `
    )
    .execute(database);
  ...
  await sql
    ...
    created_by VARCHAR(191) NOT NULL DEFAULT 'system:migration',
      ...
      CONSTRAINT billing_sales_einvoice_sale_fk FOREIGN KEY (sales_id) REFERENCES billing_sales (id) ON DELETE CASCADE,
      CONSTRAINT billing_sales_einvoice_generated_by_fk FOREIGN KEY (generated_by) REFERENCES app_users (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_einvoice_cancelled_by_fk FOREIGN KEY (cancelled_by) REFERENCES app_users (id) ON DELETE RESTRICT
    ) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
  `
    )
    .execute(database);
  ...
  await sql
    ...
    CREATE TABLE IF NOT EXISTS billing_sales_comments (
      ...
      CONSTRAINT billing_sales_comments_sale_fk FOREIGN KEY (sales_id) REFERENCES billing_sales (id) ON DELETE CASCADE,
      ...
      CONSTRAINT billing_sales_comments_created_by_fk FOREIGN KEY (created_by) REFERENCES app_users (id) ON DELETE RESTRICT,
      CONSTRAINT billing_sales_comments_updated_by_fk FOREIGN KEY (updated_by) REFERENCES app_users (id) ON DELETE RESTRICT
    ) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
  `
    )
    .execute(database);
  ...
  await sql
    ...
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
      ...
      CONSTRAINT billing_sales_activities_sale_fk FOREIGN KEY (sales_id) REFERENCES billing_sales (id) ON DELETE CASCADE,
      CONSTRAINT billing_sales_activities_actor_fk FOREIGN KEY (actor_user_id) REFERENCES app_users (id) ON DELETE RESTRICT
    ) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
  `
    )
    .execute(database);
  ...
  await sql
    ...
    created_by VARCHAR(191) NOT NULL DEFAULT 'system:migration',
      ...
      CONSTRAINT billing_sales_entry_tools_sale_fk FOREIGN KEY (sales_id) REFERENCES billing_sales (id) ON DELETE CASCADE,
      CONSTRAINT billing_sales_entry_tools_requested_by_fk FOREIGN KEY (requested_by) REFERENCES app_users (id) ON DELETE RESTRICT
    ) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
  `
    )
    .execute(database);
