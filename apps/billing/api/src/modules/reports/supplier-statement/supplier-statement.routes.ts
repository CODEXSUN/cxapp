...
import { SupplierStatementService } from "./supplier-statement.service.js";
...
const service = new SupplierStatementService();

export async function registerSupplierStatementRoutes(app: FastifyInstance) {
