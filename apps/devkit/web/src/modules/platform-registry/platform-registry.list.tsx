...
export function PlatformList(
  props: Omit<RegistryListProps<PlatformRegistryPlatformNode>, "emptyLabel" | "itemLabel">
) {
  return <RegistryTable {...props} emptyLabel="No platforms found." itemLabel="Platform" />;
}

export function ModuleGroupList(
  props: Omit<RegistryListProps<PlatformRegistryGroupNode>, "emptyLabel" | "itemLabel">
) {
  return <RegistryTable {...props} emptyLabel="No module groups found." itemLabel="Module Group" />;
}

export function ModuleList(
  props: Omit<RegistryListProps<PlatformRegistryModuleNode>, "emptyLabel" | "itemLabel">
) {
