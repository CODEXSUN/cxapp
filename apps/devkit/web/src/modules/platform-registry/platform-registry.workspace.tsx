...
export function PlatformRegistryWorkspace() {
  ...
  function openPlatform(platform?: PlatformRegistryPlatformNode) {
  ...
  function editPlatform(platform?: PlatformRegistryPlatformNode) {
  ...
  function editGroup(group?: PlatformRegistryGroupNode) {
    setEditMode("group");
    setForm(
      group
        ? formFromGroup(group)
  ...
  function editModule(module?: PlatformRegistryModuleNode) {
    setEditMode("module");
    setForm(
      module
...
function flattenGroups(groups: PlatformRegistryGroupNode[]): PlatformRegistryGroupNode[] {
  return groups.flatMap((group) => [group, ...flattenGroups(group.subGroups)]);
}

function flattenModules(modules: PlatformRegistryModuleNode[]): PlatformRegistryModuleNode[] {
  return modules.flatMap((module) => [module, ...flattenModules(module.children)]);
}

function formFromPlatform(platform: PlatformRegistryPlatformNode): EditForm {
  return { ...platform, sortOrder: String(platform.sortOrder) };
}

function formFromGroup(group: PlatformRegistryGroupNode): EditForm {
  return { ...group, sortOrder: String(group.sortOrder) };
}

function formFromModule(module: PlatformRegistryModuleNode): EditForm {
